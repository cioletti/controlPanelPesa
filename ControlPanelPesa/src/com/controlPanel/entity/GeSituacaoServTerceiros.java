 ...
 */
@Entity
@Table(name = "GE_SITUACAO_SERV_TERCEIROS")
@NamedQueries({
    @NamedQuery(name = "GeSituacaoServTerceiros.findAll", query = "SELECT g FROM GeSituacaoServTerceiros g")})
public class GeSituacaoServTerceiros implements Serializable {
    ...
    @JoinColumns({
        ...
        @JoinColumn(name = "ID_TIPO_SERVICO_TERCEIROS", referencedColumnName = "ID_TIPO_SERVICO_TERCEIROS")})
    @ManyToOne
    private GeSegmentoServTerceiros geSegmentoServTerceiros;
    @OneToMany(mappedBy = "idSituacaoServTerceiros")
    private Collection<GeLogSituacaoServTerceiros> geLogSituacaoServTerceirosCollection;

    public GeSituacaoServTerceiros() {
    }

    public GeSituacaoServTerceiros(Long id) {
        this.id = id;
    }
    ...
    public GeSegmentoServTerceiros getGeSegmentoServTerceiros() {
        return geSegmentoServTerceiros;
    }

    public void setGeSegmentoServTerceiros(GeSegmentoServTerceiros geSegmentoServTerceiros) {
        this.geSegmentoServTerceiros = geSegmentoServTerceiros;
    }

    public Collection<GeLogSituacaoServTerceiros> getGeLogSituacaoServTerceirosCollection() {
        return geLogSituacaoServTerceirosCollection;
    }

    public void setGeLogSituacaoServTerceirosCollection(Collection<GeLogSituacaoServTerceiros> geLogSituacaoServTerceirosCollection) {
        this.geLogSituacaoServTerceirosCollection = geLogSituacaoServTerceirosCollection;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GeSituacaoServTerceiros)) {
            return false;
        }
        GeSituacaoServTerceiros other = (GeSituacaoServTerceiros) object;
    ...
    public String toString() {
        return "com.gestaoequipamentos.entity.GeSituacaoServTerceiros[ id=" + id + " ]";
    }
